...
// Sub-componente interactivo para tarjetas de precios
function PricingCard({ plan, exchangeRate, symbol, handleCheckout }: any) {
...
export default function LandingClient() {
  ...
  return (
    <>
      ...
      {/* PLANES SECTION REPLACEMENT FOR PRICINGCARDS */}
      <style jsx global>{`
        .sx-plan-card {
...
// Nota: He incluido los componentes de PricingCard al final de LandingClient para mantener el archivo estructurado.
// En una refactorización mayor, estos irían a src/components/
