...
export default function WhatsAppStickyMobile() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsVisible(currentScrollY <= lastScrollY.current || currentScrollY <= 300);
  ...
  return (
    <>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="whatsapp-sticky-mobile fixed bottom-20 left-4 w-12 h-12 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] flex items-center justify-center shadow-[0_4px_16px_rgba(37,211,102,0.4)] cursor-pointer z-[9997]"
      >
