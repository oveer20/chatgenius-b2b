...
export default function CTA() {
  ...
  const contactLinks = [
    ...
    { key: "wa", label: "WhatsApp", icon: "M17.472 14.382c-.297-.149-1.758-.617-2.030-.617-.77.001-3.855.293-6.162 1.393C6.963 17.5 6 18.463 6 19.453v1.034c0 .768.488 1.47 1.156 1.953l.73 1.297c.178.316.527.5.902.5l2.35-.001c.5 0 .973-.254 1.201-.643l2.156-3.373", href: "https://wa.me/573001234567" },
